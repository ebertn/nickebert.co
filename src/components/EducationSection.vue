<template>
  <section v-if="hasEducation" id="education" class="p-8 sm:p-12 md:p-16 lg:p-24">
    <div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
        ...
        <div class="lg:col-span-8">
          <div class="space-y-8">
            <div
              v-for="edu in siteConfig.education"
              :key="`${edu.school}-${edu.degree}`"
              class="bg-white rounded-lg shadow-sm border border-gray-100 p-4 sm:p-5 md:p-6 hover:shadow-md transition-shadow duration-300"
            >
