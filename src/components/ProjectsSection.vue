<template>
  <section v-if="hasProjects" id="projects" class="p-8 sm:p-12 md:p-16 lg:p-24">
    <div>
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
        ...
        <div class="lg:col-span-8">
          <div class="space-y-8">
            <div
              v-for="(project, index) in siteConfig.projects"
              :key="project.name"
            ...
            >
              <component
                ...
                :class="[
                  ...
                  project.link ? 'hover:bg-white hover:shadow-xl hover:border-gray-300 hover:-translate-y-1' : ''
                ]"
              >
                <div
                  v-if="project.link"
                  class="absolute top-4 right-4 sm:top-6 sm:right-6 md:top-8 md:right-8 w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 flex items-center justify-center bg-gray-900 rounded-full text-white transition-all duration-300 group-hover:bg-gray-700"
                >
                  <svg
                ...
                <div class="space-y-4">
                  ...
                  <div
                    ...
                    class="flex flex-wrap gap-1.5 sm:gap-2 pt-2"
                  >
                    <span
                      v-for="skill in project.skills"
                      :key="skill"
                      :class="[
                        'px-2.5 sm:px-3 py-1 sm:py-1.5 bg-gray-900 text-white rounded-md sm:rounded-lg text-xs sm:text-sm font-medium transition-all duration-300',
